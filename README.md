...
A tool for visualization of execution traces of P and runtime. The tool converts traces into an input format (aka log) for the ShiViz tool. The ShiViz visualization engine generates interactive communication graphs - similar to Message Sequence Charts (MSCs) - from the logs.
